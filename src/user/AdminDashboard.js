...
const AdminDashboard = () => {
        ...
        return <div className="card">
            ...
            <ul className="list-group">
                <li className="list-group-item">
                    <Link to="/admin/create/category" className="nav-link text-success">Create Catogories</Link>
                </li>
                <li className="list-group-item">
                    <Link to="/admin/categories" className="nav-link text-success">Manage Catogories</Link>
                </li>
                <li className="list-group-item">
    ...
    return (
        <Base title="Admin Dashboard" className="container bg-success p-4">
            <div className="row">
                <div className="col-3">
                    {
                        adminLeftSide()
